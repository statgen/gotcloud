...
$(OUT_DIR)/beagle4/chr20/chr20.filtered.PASS.beagled.vcf.gz.tbi.OK: $(OUT_DIR)/beagle4/chr20/like/chr20.PASS.1.vcf.gz.tbi.OK
	...
	if [ -e  $(OUT_DIR)/beagle4/chr20/chr20.filtered.PASS.beagled.vcf.gz.tbi ]; then touch $(OUT_DIR)/beagle4/chr20/chr20.filtered.PASS.beagled.vcf.gz.tbi.OK; else exit 1; fi
